        ...
        <div className="w-full max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="w-full max-w-md mx-auto lg:mx-0">
              <LoginForm loginType={loginType} onLoginTypeChange={setLoginType} onLogin={handleLogin} onForgotPassword={handleForgotPassword} onCreateAccount={handleCreateAccount} />
            </div>
          </div>
        </div>
      </div>
