...
const RegisterPage = () => {
  const handleRegister = (data: { fullName: string; profession: string; gender: string; email: string; password: string; mobileNumber: string }) => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="order-1 lg:order-2 flex flex-col items-center justify-center">
              ...
              <div className="w-full flex justify-end mb-8">
                <button onClick={handleLoginRedirect} className="bg-white/90 hover:bg-white text-gray-800 font-medium py-2 px-6 rounded-lg shadow-md transition-colors">
                  Login
                </button>
              </div>

              {/* Doctor Illustration Placeholder */}
              <IllustrationPlaceholder title="Doctor Illustration" description="Placeholder" className="w-80 h-96 lg:w-96 lg:h-[500px]" />
            </div>
          </div>
        </div>
      </div>
